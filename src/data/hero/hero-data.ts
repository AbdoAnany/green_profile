...
export const heroData: HeroData = {
  profile: {
    ...
    subtitle: "Flutter",
    description:
      "Shaping the future of mobile with breathtaking design and lightning-fast performance.",
    image: "/img/me.png",
  ...
  social: {
    ...
    resume:
      "https://drive.google.com/file/d/1BPAUQVC15DQ021R_03zxnddgWXsoRwGf/view?pli=1",
    email: "mailto:eng.abdelrahman.anany@gmail.com",
  },
  stats: {
    experience: "3+",
    projects: "10+",
