/**
 * Skills Data - Centralized data for all skill-related information
 * 
 * This file contains structured data for skills, technologies, and icons used
 * throughout the portfolio. All skill data should be managed here to maintain
...
import type { LucideIcon } from 'lucide-react';ories and tech icons data
import { 
  Code, Database, Settings, TestTube, Smartphone, Cloud, GitBranch, Palette, 
  ...
  AlertCircle, AppWindow, Archive, Bot, BookOpen, Box, Boxes, ChevronRight,
  Codesandbox, CommandLine, Component, Construction, Download, Eye, FileBadge,
  FileJson, FileType, FlaskConical, FolderGit, GitCompare, GanttChart, Gauge,
