      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div ref={contentRef} className="space-y-8 scroll-slide-left">
            ...
            <div ref={statsRef} className="grid grid-cols-2 gap-6 scroll-fade-in">
          ...
          <div className="flex justify-center animate-float">
            <div className="relative">
              <div className="w-80 h-80 lg:w-96 lg:h-96 glass-card rounded-full p-4">              <div className="w-full h-full bg-gradient-to-br from-navy-400 via-ocean-400 to-emerald-400 rounded-full flex items-center justify-center relative overflow-hidden">
                  <div className="text-8xl animate-float">👨‍💻</div>
                  
                  {/* Enhanced Floating Icons with Deep Ocean Theme */}
                  <div className="absolute -top-4 -right-4 w-16 h-16 glass-card-glow rounded-full flex items-center justify-center animate-float shadow-lg shadow-ocean-500/20" style={{animationDelay: '1s'}}>
                    <span className="text-2xl">🚀</span>
                  </div>
                  <div className="absolute -bottom-4 -left-4 w-16 h-16 glass-card-glow rounded-full flex items-center justify-center animate-float shadow-lg shadow-emerald-500/20" style={{animationDelay: '2s'}}>
                    <span className="text-2xl">💡</span>
                  </div>
                  <div className="absolute top-1/4 -left-8 w-12 h-12 glass-card-glow rounded-full flex items-center justify-center animate-float shadow-lg shadow-navy-500/20" style={{animationDelay: '3s'}}>
                    <span className="text-xl">🎯</span>
                  </div>
                  
                  {/* Added New Floating Icon */}
                  <div className="absolute bottom-1/4 -right-8 w-12 h-12 glass-card-glow rounded-full flex items-center justify-center animate-float shadow-lg shadow-ocean-500/20" style={{animationDelay: '2.5s'}}>
                    <span className="text-xl">🔥</span>
                  </div>
                </div>
              </div>
