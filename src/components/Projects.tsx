        ...
        <div className="text-center mb-24">
          ...
          <div className="inline-flex items-center px-6 py-3 glass-card rounded-full text-teal-400 text-sm font-medium mb-8 relative overflow-hidden group cursor-default">
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none">
              <div className="absolute inset-0 bg-gradient-to-r from-teal-500/20 to-yellow-400/20 animate-pulse" style={{animationDuration: '3s'}}></div>
            </div>
            <Zap size={16} className="mr-2 group-hover:animate-pulse" />
            <span className="relative z-10 bg-gradient-to-r from-white to-white bg-clip-text group-hover:text-transparent group-hover:from-teal-400 group-hover:to-yellow-400 transition-all duration-500">Featured Work</span>
          </div>
          
          <SectionHeader title="My Projects" subtitle="A showcase of my recent work, personal projects and technical explorations" />
        </div>
