...
const ProjectsNew = () => {
  ...
  return (
    <Section id="projects" className="py-24">
      ...
      {/* Geometric Accents */}
      <div
        className="absolute top-32 right-1/4 w-16 h-16 border border-teal-400/20 rounded-xl rotate-45 animate-float"
        style={{ animationDelay: "1s", animationDuration: "7s" }}
      ></div>
      <div
        className="absolute bottom-40 left-1/4 w-24 h-24 border border-yellow-500/20 rounded-full animate-float"
